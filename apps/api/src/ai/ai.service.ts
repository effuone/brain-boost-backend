...
const baseRoadmapTestJsonStructure = `{"tests":[{"Question1":"What is the purpose of Source Code Management (SCM)?","Answers":["It provides a way to store and access source code","It helps developers collaborate on projects","It allows developers to roll back changes","It enables access control"],"RightAnswer":0},{"Question2":"What is the most popular Source Code Management system?","Answers":["Github","Bitbucket","Subversion","Mercurial"],"RightAnswer":0},{"Question3":"What are the benefits of using Source Code Management?","Answers":["It encourages code reuse","It enables access control","It provides better version control","It minimizes risk of data loss"],"RightAnswer":2}]}`
